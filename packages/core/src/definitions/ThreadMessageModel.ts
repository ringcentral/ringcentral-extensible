...
import type ThreadMessageModelAuthor from "./ThreadMessageModelAuthor.js";

interface ThreadMessageModel {
  /**
   ...
   */
  author?: ThreadMessageModelAuthor;
}

export default ThreadMessageModel;
