 ...
 *  which are not terminated in the RingCentral phone system
   */
  paymentType?: ('External' | 'ExternalNumberProvider' | 'Local');
 ...
 *  ported to RingCentral
   ...
   */
  usageType?: ('MainCompanyNumber' | 'AdditionalCompanyNumber' | 'CompanyNumber' | 'DirectNumber' | 'CompanyFaxNumber' | 'ForwardedNumber' | 'ForwardedCompanyNumber' | 'ContactCenterNumber' | 'IntegrationNumber');
}
