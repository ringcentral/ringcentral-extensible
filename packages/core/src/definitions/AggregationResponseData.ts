import AggregationResponseRecord from './AggregationResponseRecord';
...
interface AggregationResponseData {
   ...
   * Required
   */
  groupedBy?: ('Company' | 'CompanyNumbers' | 'Users' | 'Queues' | 'IVRs' | 'SharedLines' | 'UserGroups' | 'Sites' | 'Departments');
