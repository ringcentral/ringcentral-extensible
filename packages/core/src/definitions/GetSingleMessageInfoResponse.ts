...
import GetMessageForwardingInfo from "./GetMessageForwardingInfo.js";
 ...
 *  cover page. Maximum length is limited to 1024 symbols
  ...
  /**
   */
  forwarding?: GetMessageForwardingInfo;

  /**
   * List of other users (side recipients) who also received the voicemail in case of VM sending to multiple users or VM forwarding to multiple users.
   * Required
   */
  vmSideRecipients?: MessageStoreCallerInfoResponseTo[];
}

export default GetSingleMessageInfoResponse;
