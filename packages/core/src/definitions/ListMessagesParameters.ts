 ...
 *  feature is enabled.
   */
  ownerExtensionType?: ('User' | 'Department' | 'Announcement' | 'Voicemail' | 'DigitalUser' | 'VirtualUser' | 'FaxUser' | 'PagingOnly' | 'SharedLinesGroup' | 'DelegatedLinesGroup' | 'GroupCallPickup' | 'IvrMenu' | 'ApplicationExtension' | 'ProxyAdmin' | 'RoomConnector' | 'ParkLocation' | 'Limited' | 'Bot' | 'Site' | 'Room' | 'FlexibleUser' | 'TieLine' | 'Unknown')[];
}
