 ...
 *  corresponds to 'Call Queue' extensions in modern RingCentral product terminology
   */
  type?: ('Announcement' | 'ApplicationExtension' | 'DigitalUser' | 'DelegatedLinesGroup' | 'Department' | 'FaxUser' | 'IvrMenu' | 'PagingOnly' | 'ParkLocation' | 'SharedLinesGroup' | 'Site' | 'User' | 'VirtualUser' | 'Voicemail');
