 ...
 *  extensions in modern RingCentral product terminology
   * Example: User
   */
  extensionType?: ('User' | 'Department' | 'Announcement' | 'Voicemail' | 'DigitalUser' | 'VirtualUser' | 'FaxUser' | 'PagingOnly' | 'SharedLinesGroup' | 'DelegatedLinesGroup' | 'GroupCallPickup' | 'IvrMenu' | 'ApplicationExtension' | 'ProxyAdmin' | 'RoomConnector' | 'ParkLocation' | 'Limited' | 'Bot' | 'Site' | 'Room' | 'FlexibleUser' | 'TieLine' | 'Unknown');
