import AnalyticsLegacyCallSegmentFilter from './AnalyticsLegacyCallSegmentFilter';
import AnalyticsLegacyCallActionFilter from './AnalyticsLegacyCallActionFilter';
import AnalyticsLegacyPerformanceCallsFilterByLength from './AnalyticsLegacyPerformanceCallsFilterByLength';
import AnalyticsLegacyPerformanceCallsFilterTimeSpentByMailbox from './AnalyticsLegacyPerformanceCallsFilterTimeSpentByMailbox';

/**
 * Optional filters that limit the scope of calls to be aggregated (joined via AND)
*/
interface AnalyticsLegacyPerformanceCallsFilters {
  /**
   ...
   */
  callSegments?: AnalyticsLegacyCallSegmentFilter[];

  /**
   * Aggregation of calls by presence of specific action (joined via OR)
   */
  callActions?: AnalyticsLegacyCallActionFilter[];
  ...
  /**
   */
  callDuration?: AnalyticsLegacyPerformanceCallsFilterByLength;

  /**
   */
  timeSpent?: AnalyticsLegacyPerformanceCallsFilterTimeSpentByMailbox;
...
export default AnalyticsLegacyPerformanceCallsFilters;
