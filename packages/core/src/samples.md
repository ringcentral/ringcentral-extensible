...
- `bulkManageLicensesRequest` is of type [BulkManageLicensesRequest](./definitions/BulkManageLicensesRequest.ts)
- `result` is of type [BulkManageLicensesResponse](./definitions/BulkManageLicensesResponse.ts)
