 ...
 * 
   ...
   */
  public async post(registrantBaseModelWithQuestionnaire: RegistrantBaseModelWithQuestionnaire, restRequestConfig?: RestRequestConfig): Promise<RegistrantModelResponsePostWithQuestionnaire> {
    const r = await this.rc.post<RegistrantModelResponsePostWithQuestionnaire>(this.path(false), registrantBaseModelWithQuestionnaire, undefined, restRequestConfig);
    return r.data;
  }
 ...
 * 
   ...
   * App Permission: ReadWebinars
   */
  public async get(queryParams?: RcwRegGetRegistrantParameters, restRequestConfig?: RestRequestConfig): Promise<RegistrantModelWithQuestionnaire> {
