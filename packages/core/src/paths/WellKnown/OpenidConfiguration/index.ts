 ...
 * 
   ...
   */
  public async get(restRequestConfig?: RestRequestConfig): Promise<OpenIdDiscovery> {
    const r = await this.rc.get<OpenIdDiscovery>(this.path(), undefined, restRequestConfig);
    return r.data;
  }
}
