 ...
 * [Bulk request syntax](https://developers.ringcentral.com/guide/basics/batch-requests) is supported. For bulk requests the number of extensions
 ...
 * 
   ...
   */
  public async get(queryParams?: ReadUserPresenceStatusParameters, restRequestConfig?: RestRequestConfig): Promise<PresenceInfoResponse> {
    const r = await this.rc.get<PresenceInfoResponse>(this.path(), queryParams, restRequestConfig);
    return r.data;
  }
