 ...
 * 
   ...
   */
  public async post(extensionCreationRequest: ExtensionCreationRequest, restRequestConfig?: RestRequestConfig): Promise<GetExtensionInfoResponse> {
    const r = await this.rc.post<GetExtensionInfoResponse>(this.path(false), extensionCreationRequest, undefined, restRequestConfig);
    return r.data;
  }
