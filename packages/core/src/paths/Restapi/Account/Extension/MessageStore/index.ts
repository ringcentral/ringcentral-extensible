...
import GetSingleMessageInfoResponse from "../../../../../definitions/GetSingleMessageInfoResponse.js";
 ...
 * 
   ...
   * User Permission: ReadMessages
   */
  public async get(restRequestConfig?: RestRequestConfig): Promise<GetSingleMessageInfoResponse> {
    if (this.messageId === null)
    {
        throw new Error('messageId must be specified.');
    }
    const r = await this.rc.get<GetSingleMessageInfoResponse>(this.path(), undefined, restRequestConfig);
    return r.data;
  }
