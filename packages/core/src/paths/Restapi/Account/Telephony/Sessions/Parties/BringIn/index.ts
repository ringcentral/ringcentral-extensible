...
import AddPartyRequest from '../../../../../../../definitions/AddPartyRequest';
...
class Index {
   ...
   */
  async post(addPartyRequest: AddPartyRequest, restRequestConfig?: RestRequestConfig): Promise<CallParty> {
