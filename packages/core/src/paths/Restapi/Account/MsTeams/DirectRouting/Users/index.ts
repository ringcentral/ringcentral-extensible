...
class Index {
   ...
   */
  public async get(
    queryParams?: ListTeamsUsersParameters,
    restRequestConfig?: RestRequestConfig,
  ): Promise<MsTeamsUserListResponse> {
    const r = await this.rc.get<MsTeamsUserListResponse>(
      this.path(),
      queryParams,
      restRequestConfig,
    );
   ...
   */
  public async post(
    connectTeamsUsersRequest: ConnectTeamsUsersRequest,
    restRequestConfig?: RestRequestConfig,
  ): Promise<MsTeamsUserListResponse> {
    const r = await this.rc.post<MsTeamsUserListResponse>(
      this.path(),
      connectTeamsUsersRequest,
      undefined,
      restRequestConfig,
    );
    return r.data;
   ...
   */
  public async delete(
    queryParams?: DisconnectTeamsUsersParameters,
    restRequestConfig?: RestRequestConfig,
  ): Promise<string> {
