 ...
 *
   ...
   */
  public async post(assignMultipleDevicesAutomaticLocationUpdates: AssignMultipleDevicesAutomaticLocationUpdates, restRequestConfig?: RestRequestConfig): Promise<string> {
