 ...
 * 
   ...
   */
  public async put(callFlipNumberListResource: CallFlipNumberListResource, restRequestConfig?: RestRequestConfig): Promise<CallFlipNumberListResource> {
    const r = await this.rc.put<CallFlipNumberListResource>(this.path(), callFlipNumberListResource, undefined, restRequestConfig);
    return r.data;
  }
}
