 ...
 * 
   ...
   */
  public async list(queryParams?: ListVoiceInteractionRulesParameters, restRequestConfig?: RestRequestConfig): Promise<CommInteractionRulesResource> {
    const r = await this.rc.get<CommInteractionRulesResource>(this.path(false), queryParams, restRequestConfig);
    return r.data;
  }
 ...
 * 
   ...
   */
  public async post(commInteractionRuleCreateRequest: CommInteractionRuleCreateRequest, restRequestConfig?: RestRequestConfig): Promise<CommInteractionRuleResource> {
    const r = await this.rc.post<CommInteractionRuleResource>(this.path(false), commInteractionRuleCreateRequest, undefined, restRequestConfig);
    return r.data;
  }
 ...
 * 
   ...
   * App Permission: ReadAccounts
   */
  public async get(restRequestConfig?: RestRequestConfig): Promise<CommInteractionRuleResource> {
    if (this.ruleId === null)
    {
        throw new Error('ruleId must be specified.');
    }
    const r = await this.rc.get<CommInteractionRuleResource>(this.path(), undefined, restRequestConfig);
    return r.data;
  }
   ...
   * App Permission: EditExtensions
   */
  public async patch(commInteractionRuleUpdateRequest: CommInteractionRuleUpdateRequest, restRequestConfig?: RestRequestConfig): Promise<CommInteractionRuleResource> {
    if (this.ruleId === null)
    {
        throw new Error('ruleId must be specified.');
    }
    const r = await this.rc.patch<CommInteractionRuleResource>(this.path(), commInteractionRuleUpdateRequest, undefined, restRequestConfig);
    return r.data;
  }
}
