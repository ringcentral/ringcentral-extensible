...
import AssignPhoneNumberRequest from '../../../../../definitions/AssignPhoneNumberRequest';
import DeletePhoneNumbersResponse from '../../../../../definitions/DeletePhoneNumbersResponse';
import DeletePhoneNumbersRequest from '../../../../../definitions/DeletePhoneNumbersRequest';
import AccountPhoneNumberList from '../../../../../definitions/AccountPhoneNumberList';
import ListAccountPhoneNumbersV2Parameters from '../../../../../definitions/ListAccountPhoneNumbersV2Parameters';
 ...
 *
   ...
   */
  public async get(queryParams?: ListAccountPhoneNumbersV2Parameters, restRequestConfig?: RestRequestConfig): Promise<AccountPhoneNumberList> {
 ...
 *
   ...
   */
  public async delete(deletePhoneNumbersRequest: DeletePhoneNumbersRequest, restRequestConfig?: RestRequestConfig): Promise<DeletePhoneNumbersResponse> {
    const r = await this.rc.delete<DeletePhoneNumbersResponse>(this.path(false), deletePhoneNumbersRequest, undefined, restRequestConfig);
    return r.data;
  }
 ...
 *
   ...
   * User Permission: EditCompanyPhoneNumbers
   */
  public async patch(assignPhoneNumberRequest: AssignPhoneNumberRequest, restRequestConfig?: RestRequestConfig): Promise<AccountPhoneNumberInfo> {
    if (this.phoneNumberId === null) {
      throw new Error('phoneNumberId must be specified.');
    }
    const r = await this.rc.patch<AccountPhoneNumberInfo>(this.path(), assignPhoneNumberRequest, undefined, restRequestConfig);
    return r.data;
  }
