 ...
 * 
   ...
   * App Permission: SMS
   */
  public async get(queryParams?: ListSmsConsentRecordsParameters, restRequestConfig?: RestRequestConfig): Promise<OptRecordList> {
    const r = await this.rc.get<OptRecordList>(this.path(), queryParams, restRequestConfig);
    return r.data;
  }
 ...
 * 
   ...
   * App Permission: SMS
   */
  public async patch(updateOptRecordList: UpdateOptRecordList, restRequestConfig?: RestRequestConfig): Promise<OptRecordsModificationSummary> {
    const r = await this.rc.patch<OptRecordsModificationSummary>(this.path(), updateOptRecordList, undefined, restRequestConfig);
    return r.data;
  }
