 ...
 * 
   ...
   */
  public async post(restRequestConfig?: RestRequestConfig): Promise<WsTokenResponse> {
    const r = await this.rc.post<WsTokenResponse>(this.path(), {}, undefined, restRequestConfig);
    return r.data;
  }
}
