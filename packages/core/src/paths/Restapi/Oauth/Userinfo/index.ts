 ...
 * 
   ...
   */
  public async get(restRequestConfig?: RestRequestConfig): Promise<UserInfoResource> {
    const r = await this.rc.get<UserInfoResource>(this.path(), undefined, restRequestConfig);
    return r.data;
  }
}
