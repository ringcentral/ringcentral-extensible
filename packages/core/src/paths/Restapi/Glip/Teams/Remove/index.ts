...
class Index {
   ...
   */
  async post(glipPostMembersIdsListBody: GlipPostMembersIdsListBody, restRequestConfig?: RestRequestConfig): Promise<string> {
    const r = await this.rc.post<string>(this.path(), glipPostMembersIdsListBody, undefined, restRequestConfig);
    return r.data;
  }
}
